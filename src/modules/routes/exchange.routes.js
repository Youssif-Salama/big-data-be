...
import { filterQueryMiddleware, paginationQueryMiddleware, searchQueryMiddleware, selectQueryMiddleware, sortQueryMiddleware } from "../../middlewares/features.middlewares.js";
...
exchangeRoutes.get("/all",attachGetQueryMiddleware("exchange"),sortQueryMiddleware,searchQueryMiddleware(["_source.name","_source.symbol","_source.currency","_source.country"]),paginationQueryMiddleware,selectQueryMiddleware,checkDataFromCaching,execute(  {
    status: 200,
    result: {
      ok:true,
      message: "success"
